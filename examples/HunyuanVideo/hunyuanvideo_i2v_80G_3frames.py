...
base_save_dir = "/gpfs/share/home/2201111701/Kaiwencheng/DiffSynth-Studio/results/examples/hunyuanvideo/auto_generated"
...
for name, imgs, prompt, dir in zip(names, images, prompts, save_dirs):
    ...
    video = pipe(prompt, input_images=imgs, num_inference_steps=50, seed=0, i2v_resolution=i2v_resolution, num_frames=25)
